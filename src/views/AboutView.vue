      ...
      <section
        ...
        <div class="flex justify-center">
          <img class="w-9/12 rounded-full mb-3 fadein-up"
            src="https://i.ibb.co/ts3Wf3d/Vector-Yusuf.jpg" alt="Foto">
        </div>
        <div class="md:w-7/12">
          <p class="mb-3 md:mb-7 fadein-left fadeins-1">
            &nbsp; &nbsp; &nbsp; Hi everyone! My name is Adi Yusuf Arrasyid. I'm a web developer from Keerom, Papua. I
            have 1 year of experience in full-stack web development, Apart from that, I also have experience in UI/UX Design and No-Code Programming
