    ...
    <div class="w-full md:w-3/5 h-20 mx-auto md:mt-5">
        <div class="bg-white rounded-xl mx-3 p-5 md:p-10 md:mx-0">
            <div>
                ...
                <div class="mt-3 text-left text-gray-800 text-sm">Written on : <span>{{ date }}</span></div>
                <div class="h-[2px] w-20 my-5 md:my-10 bg-[#cfc500] md:w-1/3 aos-init aos-animate mr-2"></div>
                <div>
...
export default {
    ...
    methods: {
        async getDetails() {
            ...
            axios.get('https://65b43bdd770d43aba47b0e28.mockapi.io/api/blog/all/articles/' + id)
                .then(response => {
